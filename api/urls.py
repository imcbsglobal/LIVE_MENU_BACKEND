...
from .views import (
    ...
    get_all_companies, create_company_admin,
    toggle_company_active, set_company_pages, delete_company,
    ...
    save_user_pages, save_staff_access, get_user_stats,
    get_waiter_list,
...
urlpatterns = [
    ...
    # ── Super Admin — company management ────────────────────
    path('superadmin/companies/',             get_all_companies,     name='sa-companies'),
    path('superadmin/create-company-admin/',  create_company_admin,  name='sa-create-admin'),
    path('superadmin/toggle-company/',        toggle_company_active, name='sa-toggle-company'),
    path('superadmin/set-company-pages/',     set_company_pages,     name='sa-set-pages'),
    path('superadmin/delete-company/',        delete_company,        name='sa-delete-company'),
    ...
    path('users/<int:user_id>/staff-access/',   save_staff_access,name='save-staff-access'),
